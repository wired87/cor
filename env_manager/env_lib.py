...
class EnvManager:
    ...
    def __init__(self, qb=None):
        """
        Initialize the EnvManager instance state.

        Workflow:
        1. Reads and normalizes the incoming inputs, including `qb`.
        2. Delegates side effects or helper work through `get_qbrain_table_manager()`, `self.qb.ensure_table()`, `print()`.
        3. Finishes by updating state, triggering side effects, or completing the workflow without a direct return value.

        Inputs:
        - `qb`: Caller-supplied value used during processing.
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.__init__ | handler_line=55 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.__init__: {e}")
    ...
    def retrieve_envs_by_user_goal(
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.retrieve_envs_by_user_goal | handler_line=97 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.retrieve_envs_by_user_goal: {e}")
    ...
    def retrieve_send_user_specific_env_table_rows(self, user_id: str, select: str = "*") -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.retrieve_send_user_specific_env_table_rows | handler_line=115 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.retrieve_send_user_specific_env_table_rows: {e}")
    ...
    def retrieve_session_envs(self, user_id: str, session_id:str, select: str = "*") -> Dict[str, list]:
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.retrieve_session_envs | handler_line=141 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.retrieve_session_envs: {e}")
    ...
    def retrieve_env_from_id(
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.retrieve_env_from_id | handler_line=169 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.retrieve_env_from_id: {e}")
    ...
    def delete_env(self, env_id: str, user_id: str):
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.delete_env | handler_line=188 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.delete_env: {e}")
        ...
        try:
            ...
            if "data" in row and isinstance(row["data"], (dict, list)):
                try:
                    ...
                    print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.set_env | handler_line=208 | {type(e).__name__}: {e}")
                    print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.set_env: {e}")
                    print(f"{_ENV_DEBUG} set_env: serializing data: {e}")
            self.qb.set_item(self.TABLE_ID, row)
            print(f"{_ENV_DEBUG} set_env: done")
        except Exception as e:
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.set_env | handler_line=213 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.set_env: {e}")
        ...
        try:
            ...
            for col, payload in param_series.items():
                try:
                    ...
                    print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.update_env_param_series | handler_line=255 | {type(se).__name__}: {se}")
                    print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.update_env_param_series: {se}")
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.update_env_param_series | handler_line=261 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.update_env_param_series: {e}")
    ...
    def link_session_env(self, session_id: str, env_id: str, user_id: str):
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.link_session_env | handler_line=281 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.link_session_env: {e}")
    ...
    def rm_link_session_env(self, session_id: str, env_id: str, user_id: str):
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.rm_link_session_env | handler_line=300 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.rm_link_session_env: {e}")
    ...
    def link_env_module(self, session_id: str, env_id: str, module_id: str, user_id: str):
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.link_env_module | handler_line=321 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.link_env_module: {e}")
    ...
    def rm_link_env_module(self, session_id: str, env_id: str, module_id: str, user_id: str):
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.rm_link_env_module | handler_line=335 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.rm_link_env_module: {e}")
    ...
    def get_env_module_structure(self, session_id: str, env_id: str, user_id: str) -> Dict:
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.get_env_module_structure | handler_line=382 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.get_env_module_structure: {e}")
    ...
    def download_model(self, env_id: str, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.download_model | handler_line=405 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.download_model: {e}")
    ...
    def retrieve_logs_env(self, env_id: str, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.retrieve_logs_env | handler_line=432 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.retrieve_logs_env: {e}")
    ...
    def get_env_data(self, env_id: str, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Err core.qbrain.core.env_manager.env_lib::EnvManager.get_env_data | handler_line=454 | {type(e).__name__}: {e}")
            print(f"[exception] core.qbrain.core.env_manager.env_lib.EnvManager.get_env_data: {e}")
