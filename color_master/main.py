...
# CHAR: prompt — "Adapt color_master to generate the main animation based on the feature
# CHAR: values of all grid points separated (start = grid with white background and white
# CHAR: dots). The more value a grid point has (sum of feature values of all fields on that
# CHAR: grid point), the more it transitions from white to blue, animated over all timesteps."
