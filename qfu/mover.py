...
#https://github.com/wired87/qf_utils
class Mover:
    def __init__(self, g):
    ...
    def spread_objects_3d(
        ...
        try:
           #print("Spread items")
            ...
            print(f"Err core.qfu.mover::Mover.spread_objects_3d | handler_line=175 | {type(e).__name__}: {e}")
            print(f"[exception] core.qfu.mover.Mover.spread_objects_3d: {e}")
