...
class EqExtractor(ast.NodeVisitor):
    ...
    def _ensure_param_node(self, method_id, name):
        ...
        try:
            ...
            print(f"Err cor.utils.math.operator_handler::EqExtractor._ensure_param_node | handler_line=273 | {type(e).__name__}: {e}")
            print(f"[exception] cor.utils.math.operator_handler.EqExtractor._ensure_param_node: {e}")
    ...
    def _ensure_op_node(self, method_id, idx, op_name):
        ...
        try:
            ...
            print(f"Err cor.utils.math.operator_handler::EqExtractor._ensure_op_node | handler_line=306 | {type(e).__name__}: {e}")
            print(f"[exception] cor.utils.math.operator_handler.EqExtractor._ensure_op_node: {e}")
    ...
    def main(self):
        ...
        for nid, attrs in self.g.G.nodes(data=True):
            ...
            try:
                ...
                print(f"Err cor.utils.math.operator_handler::EqExtractor.main | handler_line=348 | {type(e).__name__}: {e}")
                print(f"[exception] cor.utils.math.operator_handler.EqExtractor.main: {e}")
...
if __name__ == "__main__":
    ...
    for code in test_codes:
        ...
        try:
            ...
            print("Err cor.utils.math.operator_handler::<module> | handler_line=432 | SyntaxError handler triggered")
            print("[exception] cor.utils.math.operator_handler.<module>: caught SyntaxError")
            print(f"Syntax Fehler in der Gleichung!")
        except Exception as e:
            print(f"Err cor.utils.math.operator_handler::<module> | handler_line=435 | {type(e).__name__}: {e}")
            print(f"[exception] cor.utils.math.operator_handler.<module>: {e}")
            print(f"Fehler: {e}")
