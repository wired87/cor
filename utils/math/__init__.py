    ...
    for (a, b) in combos:
        for symbol, func in op_patterns:
            ...
            try:
                ...
                print(f"Err core.utils.math.__init__::apply_all_operator_combinations | handler_line=16 | {type(e).__name__}: {e}")
                print(f"[exception] core.utils.math.__init__.apply_all_operator_combinations: {e}")
