...
def exec_cmd(cmd, inp=None):
    try:
        ...
        print(f"Err core.utils.run_subprocess::exec_cmd | handler_line=19 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.run_subprocess.exec_cmd: {e}")
        print(f"Error executing command {cmd}: {e.stderr}")
        print("Output:", e.stdout)
        return None
    except subprocess.TimeoutExpired as e:
        print(f"Err core.utils.run_subprocess::exec_cmd | handler_line=24 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.run_subprocess.exec_cmd: {e}")
        ...
        print(f"Err core.utils.run_subprocess::exec_cmd | handler_line=30 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.run_subprocess.exec_cmd: {e}")
...
def pop_cmd(cmd, cwd=None):
    ...
    try:
        ...
        print(f"Err core.utils.run_subprocess::pop_cmd | handler_line=101 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.run_subprocess.pop_cmd: {e}")
        raise RuntimeError(
