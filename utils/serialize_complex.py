...
def is_complex(com):
    ...
    try:
        ...
        print(f"Err core.utils.serialize_complex::is_complex | handler_line=34 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.serialize_complex.is_complex: {e}")
...
def serialize_complex_dict(com, restore=False):
    ...
    try:
        ...
        print(f"Err core.utils.serialize_complex::serialize_complex_dict | handler_line=73 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.serialize_complex.serialize_complex_dict: {e}")
...
def deserialize_complex_dict(data):
    ...
    try:
        ...
        print("Err deserialize_complex_dict", e)
    return data
...
def serialize_complex_process(com):
    ...
    try:
        ...
        print(f"Err core.utils.serialize_complex::serialize_complex_process | handler_line=118 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.serialize_complex.serialize_complex_process: {e}")
        if isinstance(com, dict):
...
def check_serilisation(data):
    ...
    try:
        ...
        print(f"Err core.utils.serialize_complex::check_serilisation | handler_line=176 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.serialize_complex.check_serilisation: {e}")
...
def convert_numeric(v):
    try:
        ...
        print(f"Err core.utils.serialize_complex::convert_numeric | handler_line=188 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.serialize_complex.convert_numeric: {e}")
        return v
...
def check_serialize_dict(data, attr_keys=None):
    ...
    try:
        ...
        print(f"Err core.utils.serialize_complex::check_serialize_dict | handler_line=208 | {type(e).__name__}: {e}")
        print(f"[exception] core.utils.serialize_complex.check_serialize_dict: {e}")
