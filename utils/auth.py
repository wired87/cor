...
def gcloud_auth_login(key_file_path: str = None):
    ...
    try:
        ...
        print("Err cor.utils.auth::gcloud_auth_login | handler_line=12 | (subprocess.CalledProcessError, FileNotFoundError) handler triggered")
        print("[exception] cor.utils.auth.gcloud_auth_login: caught (subprocess.CalledProcessError, FileNotFoundError)")
    ...
    try:
        ...
        print("Err cor.utils.auth::gcloud_auth_login | handler_line=26 | subprocess.CalledProcessError handler triggered")
        print("[exception] cor.utils.auth.gcloud_auth_login: caught subprocess.CalledProcessError")
        pass
    ...
    try:
        ...
        print(f"Err cor.utils.auth::gcloud_auth_login | handler_line=59 | {type(e).__name__}: {e}")
        print(f"[exception] cor.utils.auth.gcloud_auth_login: {e}")
...
def execute_deployment(command):
    ...
    try:
        ...
        print(f"Err cor.utils.auth::execute_deployment | handler_line=100 | {type(e).__name__}: {e}")
        print(f"[exception] cor.utils.auth.execute_deployment: {e}")
        print(f"\n❌ DEPLOYMENT FAILED.")
