...
class WebsocketHandler:
    ...
    async def establish_connection(self):
        try:
            ...
            print(f"Err core.utils.dj_websocket.handler::WebsocketHandler.establish_connection | handler_line=82 | {type(e).__name__}: {e}")
            print(f"[exception] core.utils.dj_websocket.handler.WebsocketHandler.establish_connection: {e}")
