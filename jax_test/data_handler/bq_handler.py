...
from jax_test.data_handler.load_sa_creds import load_service_account_credentials
...
class BQGroundZero:
    ...
    def ensure_dataset_exists(self, ds_name=None):
        ...
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BQGroundZero.ensure_dataset_exists | handler_line=54 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQGroundZero.ensure_dataset_exists: {e}")
        ...
        try:
            ...
            if result:
                try:
                    ...
                    print(f"Err cor.jax_test.data_handler.bq_handler::BQGroundZero.run_query | handler_line=293 | {type(e).__name__}: {e}")
                    print(f"[exception] cor.jax_test.data_handler.bq_handler.BQGroundZero.run_query: {e}")
                    print("Query result has no len:", e)

            return result
        except Exception as e:
            print(f"Err cor.jax_test.data_handler.bq_handler::BQGroundZero.run_query | handler_line=298 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQGroundZero.run_query: {e}")
...
class BQCore(BQGroundZero):
    ...
    def get_table_schema(self, table_id: str, schema: dict[str, str], create_if_not_exists: bool = True):
        ...
        try:
            ...
            print("Err cor.jax_test.data_handler.bq_handler::BQCore.get_table_schema | handler_line=340 | NotFound handler triggered")
            print("[exception] cor.jax_test.data_handler.bq_handler.BQCore.get_table_schema: caught NotFound")
            if create_if_not_exists:
                ...
                try:
                    ...
                    print("Err cor.jax_test.data_handler.bq_handler::BQCore.get_table_schema | handler_line=349 | Conflict handler triggered")
                    print("[exception] cor.jax_test.data_handler.bq_handler.BQCore.get_table_schema: caught Conflict")
                    print(f"Table '{table_id}' already exists (Conflict).")
            else:
                print(f"Table '{table_id}' not found. Creation is disabled.")
        except Exception as e:
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.get_table_schema | handler_line=354 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.get_table_schema: {e}")
    ...
    def bq_check_table_exists(self, table_name):
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.bq_check_table_exists | handler_line=386 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.bq_check_table_exists: {e}")
    ...
    def set_ds_open_src(self, dataset_ref):
        ...
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.set_ds_open_src | handler_line=436 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.set_ds_open_src: {e}")
    ...
    def get_create_bq_table(self, table_name, query=None, ttype="node"):
        ...
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.get_create_bq_table | handler_line=459 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.get_create_bq_table: {e}")
    ...
    def bq_get_table_schema(self, table_name):
        if table_name:
            try:
                ...
                print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.bq_get_table_schema | handler_line=471 | {type(e).__name__}: {e}")
                print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.bq_get_table_schema: {e}")
    ...
    def update_bq_schema(self, table, rows):
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.update_bq_schema | handler_line=502 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.update_bq_schema: {e}")
    ...
    def up2bq(self, table_id, csv_data, mode="o"):
        ...
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.up2bq | handler_line=557 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.up2bq: {e}")
    ...
    def ensure_table_exists(self, table_name: str,rows:list, ds_id=None):
        ...
        try:
            ...
            print("Err cor.jax_test.data_handler.bq_handler::BQCore.ensure_table_exists | handler_line=598 | NotFound handler triggered")
            print("[exception] cor.jax_test.data_handler.bq_handler.BQCore.ensure_table_exists: caught NotFound")
            print(f"Table {table_name} not found, creating...")
            table = bigquery.Table(table_ref, schema=schema)
            try:
                self.bqclient.create_table(table)
            except Conflict:
                print("Err cor.jax_test.data_handler.bq_handler::BQCore.ensure_table_exists | handler_line=604 | Conflict handler triggered")
                print("[exception] cor.jax_test.data_handler.bq_handler.BQCore.ensure_table_exists: caught Conflict")
                print(f"Table {table_name} already exists (Conflict).")

        except Exception as e:
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.ensure_table_exists | handler_line=608 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.ensure_table_exists: {e}")
    ...
    def list_tables(self) -> list:
        ...
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BQCore.list_tables | handler_line=705 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BQCore.list_tables: {e}")
            print(f"An error occurred: {e}")
            return None
...
class BigQueryGraphHandler(BQCore):
    ...
    def get_column_names(self, table_name: str):
        ...
        try:
            ...
            print(f"Err cor.jax_test.data_handler.bq_handler::BigQueryGraphHandler.get_column_names | handler_line=835 | {type(e).__name__}: {e}")
            print(f"[exception] cor.jax_test.data_handler.bq_handler.BigQueryGraphHandler.get_column_names: {e}")
        ...
        for row in results:
            ...
            for col_name in selected_cols_with_distance:
                 ...
                 try:
                     ...
                     print("Err cor.jax_test.data_handler.bq_handler::BigQueryRAG.bigquery_vector_search | handler_line=974 | ValueError handler triggered")
                     print("[exception] cor.jax_test.data_handler.bq_handler.BigQueryRAG.bigquery_vector_search: caught ValueError")
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("BQML Search Results:", results_bqml)
         ...
         print(f"Err cor.jax_test.data_handler.bq_handler::<module> | handler_line=1096 | {type(e).__name__}: {e}")
         print(f"[exception] cor.jax_test.data_handler.bq_handler.<module>: {e}")
         print(f"Error: {e}. Please implement the 'embed' function or provide a valid BQML model.")
    except Exception as e:
        print(f"Err cor.jax_test.data_handler.bq_handler::<module> | handler_line=1099 | {type(e).__name__}: {e}")
        print(f"[exception] cor.jax_test.data_handler.bq_handler.<module>: {e}")
        print(f"An error occurred: {e}")
