...
class ModuleUtils:
    ...
    def extract_index_from_center(self, index:list):
...
class Node(nnx.Module):
    ...
    a dedicated neighbor runner is set; otherwise the normal `cor()` path is used.
    """
    ...
    def core(
        ...
        # gien: prompt — no stdout inside vmap/JIT hot path; prints here stall simulation runtime
        ...
        # Robustness: Sanitise any NaNs or Infinities generated by the equations
