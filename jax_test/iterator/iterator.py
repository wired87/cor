    ...
    def extract_segment_arrays(self, ctlr, segment_spec, *, data_store=None, feature_store=None, energy_store=None):
        ...
        if energy_store is not None:
            ...
            try:
                ...
                print("Err cor.jax_test.iterator.iterator::Iterator.extract_segment_arrays | handler_line=205 | Exception handler triggered")
                print("[exception] cor.jax_test.iterator.iterator.Iterator.extract_segment_arrays: caught Exception")
                energy_states = jnp.array([])
